      ...
      <div className="recent-content">
        ...
        {filtered.length === 0 ? (
          ...
          >
            ...
            {!searchQuery && (
              <Link to="/home" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '12px 24px', borderRadius: '12px', background: 'var(--text-primary)', color: 'var(--bg-primary)', fontWeight: 600, fontSize: '14px', textDecoration: 'none', transition: 'transform 0.2s' }}>
