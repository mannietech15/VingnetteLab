...
export default function FavouritesPage() {
  ...
  return (
    <main className="main-content" style={{ background: 'var(--bg-primary)' }}>
      ...
      {/* Content Area */}
      <div style={{ padding: '24px 48px 64px', maxWidth: '1200px', margin: '0 auto' }}>
        ...
        {filtered.length === 0 ? (
          ...
          >
            ...
            {!searchQuery && (
              <Link href="/home" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '12px 24px', borderRadius: '12px', background: 'var(--accent-primary)', color: '#fff', fontWeight: 600, fontSize: '14px', textDecoration: 'none', boxShadow: '0 4px 12px var(--accent-light)', transition: 'transform 0.2s' }}>
